...
def tsnescatterplot(model, word, list_names):
    ...
    plt.savefig('../../reports/word_vectors.png')
...
def make_models():
    ...
    for c in classes:
        ...
        if(c=='all'):
            word_vectors.save(f"../../models/all.word2vec.npy")
        elif(c==0):
            word_vectors.save(f"../../models/motivational.word2vec.npy")
        else:
            word_vectors.save(f"../../models/nonMotivational.word2vec.npy")
...
def plot_common(model_0,model_1,words):
    ...
    plt.savefig('../../reports/word_vectors_common.png')
...
# make_models()
w2v_model_all = KeyedVectors.load("../../models/all.word2vec.npy", mmap='r')
w2v_model_0 = KeyedVectors.load("../../models/motivational.word2vec.npy", mmap='r')
w2v_model_1 = KeyedVectors.load("../../models/nonMotivational.word2vec.npy", mmap='r')
